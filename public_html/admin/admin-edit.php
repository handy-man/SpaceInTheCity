...
if ($result == 1){
$update = mysqli_query($connect, "UPDATE `users` SET `admin` = '2' WHERE `email` = '$admin_email'");
$_SESSION['editpushed'] = true;
$user_id=$_SESSION['uid'];
$event = "The following user was given admin! " . $admin_email . ".";
...
$_SESSION['editpushed'] = true;
$user_id=$_SESSION['uid'];
$event = "The following user had admin taken away! " . $admin_email . ".";
log_admin($connect, $user_id, $event);
}
else{
$noadmins = true;
